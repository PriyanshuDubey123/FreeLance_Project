          ...
          {isDropdownOpen && (
            <div className="mt-2 bg-white shadow-lg rounded-lg p-4">
              <ul className="space-y-2">
                <li className="p-2 bg-gray-100 rounded-lg">Purchase 1: JEE Main Math Book</li>
                <li className="p-2 bg-gray-100 rounded-lg">Purchase 2: Physics Formula Sheet</li>
                <li className="p-2 bg-gray-100 rounded-lg">Purchase 3: Chemistry Revision Notes</li>
              </ul>
            </div>
          )}
        </div>
        <div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-6">
            <div className="flex justify-between items-center mb-2">
              ...
              <button className="text-blue-500 hover:underline" onClick={() => setDailyGoal(0)}>Edit</button>
            </div>
